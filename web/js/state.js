...
const SEVERANCE_PASSENGERS = [
  ...
  { firstName: 'Harmony', lastName: 'Cobel',      tier: 'Platinum', origin: 'FRA', destination: 'ORD', flightNumber: 'DL512',  constraints: ['arrive_before_21_00'], seat: '1A',  disruptionType: 'DELAY',        disruptionCause: 'Crew rest requirements exceeded' },
  // ── Gold (4) ────────────────────────────────────────────
